...
func TestRequireEntityByID_InternalError(t *testing.T) {
	...
	_, err = db.Exec(`CREATE TABLE tags (id INTEGER PRIMARY KEY, name TEXT, slug TEXT, language_code TEXT NOT NULL DEFAULT 'en', created_at DATETIME, updated_at DATETIME)`)
	if err != nil {
