...
func TestModuleNew(t *testing.T) {
	...
	if m.Name() != "page_analytics" {
		t.Errorf("Name() = %q, want %q", m.Name(), "page_analytics")
	}
	...
	if m.AdminURL() != "/admin/page-analytics" {
		t.Errorf("AdminURL() = %q, want %q", m.AdminURL(), "/admin/page-analytics")
	}
}
